...
[Fuzzy Filters](https://code.kx.com/kdb-x/reference/ai-libs/fuzzy-index-parameters.html) enable a user to retrieve records from their data that have slight variations to the specified query term and filters.
