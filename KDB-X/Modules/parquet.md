...
This tutorial outlines how to integrate KDB-X with tables in Parquet format on disk, and how to seamlessly perform common operations and calculations on both single tables and multiple tables in memory.

## Prerequisites

1. View the [KDB-X Docs](https://code.kx.com/kdb-x/index.html) for full details on KDB-X and KDB-X Python.
Requires KDB-X to be installed, you can sign up [here](https://developer.kx.com/products/kdb-x/install). For full install instructions see: [KDB-X Install](https://code.kx.com/kdb-x/get_started/kdb-x-install.html).
